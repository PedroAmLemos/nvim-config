...
map('n', '<leader>gits', ":lua require('conf.telescope').git_status()<CR>", opts)
map('n', '<leader>vrc', ":lua require('conf.telescope').edit_neovim()<CR>", opts)
map('n', '<leader>ge', ":lua require('conf.telescope').search_only_certain_files()<CR>", opts)
-- map('n', '<leader>ca', ":lua require('conf.telescope').lsp_code_actions()<CR>", opts)
map('n', '<leader>lr', ":lua require('conf.telescope').lsp_references()<CR>", opts)
map('n', '<leader>li', ":lua require('conf.telescope').lsp_implementations()<CR>", opts)
